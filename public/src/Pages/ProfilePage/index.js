    ...
    <section fluid className="Profilecont">
      ...
      <section className="Profilerow1">
        ...
        <div className="profilecont">
          <span>Peddagudam Chinna Narashimha</span>
          <p>ID: KFP/K/10</p>
        </div>
      </section>
      <section className="profilecontaintrow">
        ...
        <div className="diviconcont">
          ...
          <div className="divicontaint">
            <span>Address</span>
            <p>Plot no: 91p, 92p, Sai Nagar, Kashimnagar, Telangana 500042</p>
          </div>
        </div>
      </section>
    </section>
